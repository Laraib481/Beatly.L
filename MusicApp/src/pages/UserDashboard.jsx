...
//   // Check whether this page is being used as "Explore Other"
...
//     // If artist is exploring other artists,
//     // hide their own songs
//     if (
//       isArtistExplore &&
...
//       <nav className="flex flex-col lg:flex-row items-center justify-between gap-5 px-5 sm:px-8 lg:px-10 py-6">
...
//           <div className="lg:hidden w-11 h-11 rounded-full bg-[#D4A574] flex items-center justify-center text-black font-bold">
...
//           <div className="flex items-center bg-[#111] px-4 sm:px-5 py-3 rounded-full w-full sm:w-96">
...
//           <Bell className="hidden sm:block cursor-pointer text-gray-300 hover:text-[#D4A574] shrink-0" />

//           {/* Desktop profile */}

//           <div className="hidden lg:flex w-11 h-11 rounded-full bg-[#D4A574] items-center justify-center text-black font-bold shrink-0">
//             {user?.username?.charAt(0)?.toUpperCase() || "L"}
//           </div>
...
//       {isArtistExplore && (
//         <div className="px-5 sm:px-8 lg:px-16 pt-4">

//           <button
//             onClick={() => navigate("/dashboard")}
//             className="flex items-center gap-2 text-gray-400 hover:text-[#D4A574] duration-300"
//           >
//             <ArrowLeft size={18} />
...
//       <section className="grid lg:grid-cols-2 items-center px-5 sm:px-8 lg:px-16 pt-10 lg:pt-12">

//         {/* Left */}

//         <div>

//           <p className="tracking-[4px] sm:tracking-[7px] text-[#D4A574] mb-6 text-sm sm:text-base">
//             {isArtistExplore
...
//           <p className="text-gray-400 mt-8 text-base sm:text-lg leading-8 max-w-xl">
...
//             }}
//             className="mt-10 bg-[#D4A574] text-black px-7 sm:px-8 py-4 rounded-full font-semibold hover:scale-105 duration-300 flex items-center gap-3"
//           >

//             <Play size={18} />

//             {isArtistExplore ? "Explore Songs" : "Explore Music"}
...
//           <div className="absolute w-[280px] sm:w-[420px] h-[280px] sm:h-[420px] rounded-full bg-[#D4A574]/20 blur-[100px] sm:blur-[120px]" />

//           <img
//             src={vinyl}
//             alt="Vinyl"
//             className="w-[330px] sm:w-[480px] lg:w-[620px] animate-spin-slow relative z-10"
//           />
...
//       <section
//         id="music-section"
//         className="px-5 sm:px-8 lg:px-16 mt-20 lg:mt-24 pb-20"
//       >
...
//                 <div className="h-56 sm:h-64 relative bg-[#222]">
